...
и несколько вложенных директорий, в каждой из которых есть по несколько вложенных директорий и по одному файлу README. И в тех вложенных директориях то же самое. Предпорложим, что в одном из файлов README лежит наш флаг. 

Надо создать скрипт, который просканирует все вложенные директории и найдёт этот флаг.
